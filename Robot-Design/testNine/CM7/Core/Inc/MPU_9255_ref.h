...
#ifndef __MPU9255_REF_H
#define __MPU9255_REF_H
#ifdef __cplusplus
extern "C" {
#endif
/* Defines ------------------------------------------------------------------*/
...
//#define ADO 0
//#if ADO
#define MPU9255_ADDRESS_AD0_0 0x69<<1  // Device address when ADO = 1
//#else
#define MPU9255_ADDRESS_AD0_1 0x68<<1  // Device address when ADO = 0
//#endif  
