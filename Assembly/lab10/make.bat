...
REM del lab10.lst	REM lab10可以替換成.asm檔的檔名
REM del lab10.ilk
del lab10.pdb
del lab10.exe
...
LINK /INCREMENTAL:no /debug /subsystem:console /entry:start /out:lab10.exe lab10.obj Kernel32.lib irvine32.lib user32.lib
if errorlevel 1 goto terminate
