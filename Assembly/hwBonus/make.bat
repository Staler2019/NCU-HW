...
REM del hwBonus.lst	REM hwBonus可以替換成.asm檔的檔名
REM del hwBonus.ilk
del hwBonus.pdb
del hwBonus.exe
...
LINK /INCREMENTAL:no /debug /subsystem:console /entry:start /out:hwBonus.exe hwBonus.obj Kernel32.lib irvine32.lib user32.lib
if errorlevel 1 goto terminate
