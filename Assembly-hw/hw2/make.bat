...
REM del hw2.lst	REM hw2可以替換成.asm檔的檔名
REM del hw2.ilk
del hw2.pdb
del hw2.exe
...
LINK /INCREMENTAL:no /debug /subsystem:console /entry:start /out:hw2.exe hw2.obj Kernel32.lib irvine32.lib user32.lib
if errorlevel 1 goto terminate
