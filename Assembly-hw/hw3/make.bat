...
REM del hw3.lst	REM hw3可以替換成.asm檔的檔名
REM del hw3.ilk
del hw3.pdb
del hw3.exe
...
LINK /INCREMENTAL:no /debug /subsystem:console /entry:start /out:hw3.exe hw3.obj Kernel32.lib irvine32.lib user32.lib
if errorlevel 1 goto terminate
