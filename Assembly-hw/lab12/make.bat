...
REM del lab12.lst	REM lab12可以替換成.asm檔的檔名
REM del lab12.ilk
del lab12.pdb
del lab12.exe
...
LINK /INCREMENTAL:no /debug /subsystem:console /entry:start /out:lab12.exe lab12.obj Kernel32.lib irvine32.lib user32.lib
if errorlevel 1 goto terminate
