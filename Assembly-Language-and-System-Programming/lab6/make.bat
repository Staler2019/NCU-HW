...
REM del week07.lst	REM week07可以替換成.asm檔的檔名
REM del week07.ilk
del week07.pdb
del week07.exe
...
LINK /INCREMENTAL:no /debug /subsystem:console /entry:start /out:week07.exe week07.obj Kernel32.lib irvine32.lib user32.lib
if errorlevel 1 goto terminate
