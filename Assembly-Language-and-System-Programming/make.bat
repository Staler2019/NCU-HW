...
REM del test1.lst	REM test1可以替換成.asm檔的檔名
REM del test1.ilk
del test1.pdb
del test1.exe
...
LINK /INCREMENTAL:no /debug /subsystem:console /entry:start /out:test1.exe test1.obj Kernel32.lib irvine32.lib user32.lib
if errorlevel 1 goto terminate
