...
REM del lab9.lst	REM lab9可以替換成.asm檔的檔名
REM del lab9.ilk
del lab9.pdb
del lab9.exe
...
LINK /INCREMENTAL:no /debug /subsystem:console /entry:start /out:lab9.exe lab9.obj Kernel32.lib irvine32.lib user32.lib
if errorlevel 1 goto terminate
