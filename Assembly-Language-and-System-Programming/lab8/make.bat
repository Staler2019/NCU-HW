...
REM del lab8.lst	REM lab8可以替換成.asm檔的檔名
REM del lab8.ilk
del lab8.pdb
del lab8.exe
...
LINK /INCREMENTAL:no /debug /subsystem:console /entry:start /out:lab8.exe lab8.obj Kernel32.lib irvine32.lib user32.lib
if errorlevel 1 goto terminate
