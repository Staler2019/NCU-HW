...
REM del week06.lst	REM week06可以替換成.asm檔的檔名
REM del week06.ilk
del week06.pdb
del week06.exe
...
LINK /INCREMENTAL:no /debug /subsystem:console /entry:start /out:week06.exe week06.obj Kernel32.lib irvine32.lib user32.lib
if errorlevel 1 goto terminate
